...
public final class Constants {
    ...
    public static final String PROP_BUILD_DATE = "ro.stag.build_date_utc";
    ...
    static final String PROP_VERSION_CODE = "sx";
    static final String OTA_URL = "https://https://raw.githubusercontent.com/StagOS-Devices/OTA/master/s%.json";
    static final String DOWNLOAD_WEBPAGE_URL = "http://download.stag-os.me/%s/%s/%s";
