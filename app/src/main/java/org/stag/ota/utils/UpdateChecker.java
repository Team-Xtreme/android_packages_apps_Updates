...
import org.stag.ota.UpdaterApplication;
import org.stag.ota.activities.UpdaterActivity;
import org.stag.ota.misc.Constants;
import org.stag.ota.misc.State;
import org.stag.ota.misc.UpdateInfo;
import org.stag.ota.requests.UpdatesJsonObjectRequest;
import org.stag.ota.service.UpdateCheckService;
...
public class UpdateChecker implements Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    // broadcast actions
    public static final String ACTION_CHECK_FINISHED = "org.stag.ota.action.UPDATE_CHECK_FINISHED";
