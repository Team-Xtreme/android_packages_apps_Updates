 ...
 */
package org.stag.ota.misc;

import android.app.AlarmManager;

public class Constants {
    // Download related
    public static final String UPDATES_FOLDER = "StagOS-Updates";
    ...
    public static final String DOWNLOAD_CHANNEL_ID = "org.stag.ota.DOWNLOAD_CHANNEL";
    public static final String DOWNLOADING_CHANNEL_ID = "org.stag.ota.DOWNLOADING_CHANNEL";
    // Preferences
    ...
    // Build vars
    public static final String CURRENT_DEVICE_NAME = "ro.stag.device";
    public static final String CURRENT_VERSION = "ro.stag.version";
    public static final String OTA_URL = "https://raw.githubusercontent.com/Team-Xtreme/stag_ota/master/%s.json";
    public static final String OTA_VERSION_CODE = "Q";
    // Expressions
